...
import { MapPinIcon, MailIcon, Star, Award, CheckCircle, AlertCircle, Edit2Icon } from 'lucide-react';
...
const ProfileInfo: React.FC<ProfileInfoProps> = ({ userData, onUpdate }) => {
    ...
    const renderStatCard = (title: string, value: number | string, icon: React.ReactNode) => (
        <div className="bg-[rgba(99,102,241,0.1)] border border-indigo-900/30 rounded-xl p-4 flex flex-col">
        ...
        <div className="space-y-6">
            ...
            <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    {renderStatCard('Time Saved', formatDistanceOrTime(userData.stats.totalTimeSaved), <Award size={16} className="text-indigo-400" />)}
                </div>
            </div>
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        {userData.favoriteLocations.map((location, index) => (
                            <div
                                key={index}
                                className="bg-[rgba(15,18,30,0.95)] border border-indigo-900/30 rounded-xl p-4 shadow-lg shadow-indigo-900/10"
                            >
                                <div className="flex items-center mb-2">
                                    <div className="w-8 h-8 rounded-lg bg-indigo-900/50 flex items-center justify-center mr-2">
