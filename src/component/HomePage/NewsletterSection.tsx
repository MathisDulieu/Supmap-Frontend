                            ...
                            <div className="flex flex-col md:flex-row items-center">
                                ...
                                <div className="md:w-1/3 w-full">
                                    ...
                                    <p className="mt-4 text-xs text-gray-500 leading-relaxed">
                                        By subscribing, you agree to our <a href="/privacy-policy" className="text-indigo-400 hover:text-indigo-300 transition-colors duration-300">Privacy Policy</a> and
                                        consent to receive updates from Supmap. You can unsubscribe at any time.
                                    </p>
                                </div>
                            </div>
                        </div>
